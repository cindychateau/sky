 ...
 */
define("PAGE_TITLE", "Administración de Carpetas");
define("PAGE_DESCRIPTION", "Agregar, eliminar y modificar carpetas y documentos.");
...
<html lang="es">
	<head>
	    ...
	    <style type="text/css">
			...
			.fileUpload input#doc, .fileUpload input#pdfs {
			    position: absolute;
			    top: 0;
			    right: 0;
			    margin: 0;
				...
				<div class="content">
					<div class="page-inner">
						...
						<div class="table-responsive">
							<!--form id="frm-prueba" name="frm-prueba">
								<input type="file" name="pdf[]" id="pdf" multiple directory webkitdirectory="">
