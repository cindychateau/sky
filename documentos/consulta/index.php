 ...
 */
define("PAGE_TITLE", "Consulta");
define("PAGE_DESCRIPTION", "Búsqueda de Documentos, tanto por contexto como por nombre de archivo.");
							...
							<div class="card">
								<div class="form-group">
									<div class="input-group">
										<input type="text" class="form-control" placeholder="Ingrese el término a buscar y presione enter..." name="term" id="term">
										<div class="input-group-append">
											<button id="btn-accion" class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Búsqueda Contextual</button>
											<div class="dropdown-menu">
												<a class="dropdown-item" href="#" data-action="context">Contextual</a>
												<a class="dropdown-item" href="#" data-action="name">Por Nombre</a>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="row">
											<div class="col-sm-3">
												<select class="form-control" id="order" name="order">
													...
													<option value="fd">Más Recientes</option>
													<option value="fa">Más Antigüos</option>
												</select>
											</div>
