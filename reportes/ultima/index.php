 ...
 */
define("PAGE_TITLE", "Reporte de Última Alta por Cliente");
define("PAGE_DESCRIPTION", "Favor de seleccionar las fechas deseadas para desplegar el reporte.");
				...
				<div class="content">
					<div class="page-inner">
						...
						<div class="row">
							...
							<div class="col-sm-2">
								<button class="btn btn-primary ver-reporte" title=""><i class="fas fa-table"></i> Ver Reporte</button>
							</div>
							<div class="col-sm-2 offset-1 cont-guardar">
