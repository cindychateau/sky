...
define("PAGE_DESCRIPTION", "Edición de la información de un cliente dado previamente de alta.");
						...
						<form id="frm-cliente">
							<div class="card">
								<div class="card-body">
									...
									<div class="form-group row">
										<label for="prefijo" class="col-sm-2 mt-sm-2 text-right">Prefijo <span class="required-label">*</span></label>
										<div class="col-sm-4">
